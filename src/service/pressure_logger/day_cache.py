...
class DayCache:
    def __init__(self, id: int, date: datetime, accumulated_occiput: int, accumulated_scapula: int, accumulated_elbow: int, accumulated_heel: int, accumulated_hip: int, logs: list[PressureCache]):
        self.id = id
        self.date = date
